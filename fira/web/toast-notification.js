...
class ToastNotification {
    ...
    detectWebVersion() {
        ...
        // Web version is when running on production server (NOT localhost and NOT file://)
        // This will show toasts ONLY on production web version
        const isWeb = (protocol !== 'file:' && hostname !== '' && !isLocalhost);
